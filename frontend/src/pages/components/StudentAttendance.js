...
const StudentAttendance = ({ userId }) => {
  ...
  const calculateAcademicYearStats = () => {
    // 2026-2027 runs from June 1, 2026 to May 31, 2027
    ...
    const offDays = isCurrentYear ? 145 : 150; // Weekends + official holidays
  ...
  // Active stats for Month or Week
    ...
    <div className="space-y-8">
      ...
      <div className="rounded-3xl bg-gradient-to-r from-[#0C4A86] to-[#0096DA] p-6 text-white shadow-md flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-2xl font-bold">Attendance Register & Academic Overview</h1>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 pb-4">
          <div>
            ...
            <p className="text-xs font-semibold text-slate-500">
              Complete attendance metrics for the selected academic year
            </p>
          </div>
